...
import 'package:awesome_period_tracker/data/services/ai_cycle_prediction_service.dart';
...
class ForecastService {
  const ForecastService(this._env, this._cyclePredictionService);

  final Env _env;
  final AiCyclePredictionService _cyclePredictionService;
  ...
  Future<Forecast> createForecastForDateFromEvents(
    ...
    final apiPrediction = await _cyclePredictionService.fetchPrediction(events);
